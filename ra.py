...
def printMsg():
    if((entry_1.get()=='ashwanth' and entry_2.get()=='844') or (entry_1.get()=='prakash' and entry_2.get()=='844') or (entry_1.get()=='bibin' and entry_2.get()=='844') ):
            ...
            if(len1==10):
                if(int(date1)<=31 and int(date1)>=1):
                    if(int(month1)>=1 and int(month1)<=12):
                        if(int(year11)>=2022 and int(year11)<=2030):
                            print('')
                        else:
